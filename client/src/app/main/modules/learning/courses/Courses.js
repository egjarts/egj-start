...
function Courses(props)
{
    ...
    const courses = useSelector(({learningModule}) => learningModule.courses.data);
    const categories = useSelector(({learningModule}) => learningModule.courses.categories);
...
export default withReducer('learningModule', reducer)(Courses);
