...
{
    const request = axios.get('/api/learning-app/course', {params});
...
export function saveCourse(data)
{
    ...
    const request = axios.post('/api/learning-app/course/save', data);
...
export function updateCourse(data)
{
    ...
    return (dispatch, getState) => {
        ...
        const {id} = getState().learningModule.course;
        const request = axios.post('/api/learning-app/course/update', {id, ...data});
